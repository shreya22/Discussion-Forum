...
if(isset($_POST['submit']))
{
	...
	$randomstring=null;
		...
		"register.php?error=taken");
			...
			$verifyurl = "http://127.0.0.1/myforum/verify.php";
	...
	/*		$mail_body=<<<_MAIL_  //mail wont be sent, error in this line!
			Hi $validusername,
			Please click on the following link to verify your new account:
			$verifyurl?email=$verifyemail&verify=$verifystring _MAIL_;
			
			mail($_POST['email'], $config_forum . " User
...
<h2>Register</h2>
to register on the <?php echo $config_forum; ?> forums, fill in the form below!.
